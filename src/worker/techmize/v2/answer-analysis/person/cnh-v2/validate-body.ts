...
import { TechmizeV2AnswerAnalysisCNHV2BodyValue } from './main'

const documentRegex = /^[0-9]{3}\.?[0-9]{3}\.?[0-9]{3}\-?[0-9]{2}$/

const schema = Joi.object<TechmizeV2AnswerAnalysisCNHV2BodyValue, true>({
  cpf: Joi
    .string()
    .regex(documentRegex)
    .required(),
...
const validateBody = (
  data: Partial<TechmizeV2AnswerAnalysisCNHV2BodyValue>,
): TechmizeV2AnswerAnalysisCNHV2BodyValue => {
