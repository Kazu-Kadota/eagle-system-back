...
const techmizeV2AnswerAnalysisVehicleANTT: SQSStepFunctionController<TechimzeVehicleSQSReceivedMessageAttributes> = async (message) => {
  ...
  const antt_result: TechmizeV2GetResponseResponse | TechmizeV2GetRequestErrorResponse = get_response_techimze
  ...
  const antt = (antt_result as TechmizeV2ConsultarANTTResponseSuccess).data.antt[0]
