...
const validateBodyOperatorCompaniesAccessDeleteCompanies = (
  ...
  if (error) {
    logger.error('Error on validate "operator companies access delete companies" body')
...
export default validateBodyOperatorCompaniesAccessDeleteCompanies
